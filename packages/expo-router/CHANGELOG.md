...
- Abort in-flight loader requests when their routes are removed from navigation state ([#48451](https://github.com/expo/expo/pull/48451) by [@hassankhan](https://github.com/hassankhan))
