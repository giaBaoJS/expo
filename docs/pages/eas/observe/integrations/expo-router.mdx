...
Per-route metrics appear in the **Navigation** tab of the [EAS Observe dashboard](/eas/observe/dashboard/). From the terminal, query them by route with `eas observe:routes`:
